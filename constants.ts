...
export const INITIAL_EQUIPMENT_ITEMS: EquipmentItem[] = [
  ...
  { id: '7', code: '10021', name: 'R2 0-5 Deg.', price: 583.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '8', code: '10022', name: 'R2 5-60 Deg.', price: 578.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '9', code: '10062', name: 'R2DDE', price: 2365.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '10', code: '10024', name: 'R2DE', price: 1214.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '11', code: '10001', name: 'R4 0-5 Deg.', price: 851.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '12', code: '10002', name: 'R4 5-60 Deg.', price: 986.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  // Parent Item
  { id: '13', code: '', name: 'R4DDE', price: 4394.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  // Child Items
  { id: '13-1', code: '10052-A', name: 'R4DDE ON LT. 50sq.mm.', price: 4394.00, unit: 'ชุด', department: 'แผนกแรงต่ำ', parentId: '13' },
  { id: '13-2', code: '10052-B', name: 'R4DDE ON LT. 95sq.mm.', price: 4394.00, unit: 'ชุด', department: 'แผนกแรงต่ำ', parentId: '13' },
  
  { id: '14', code: '10004', name: 'R4DE', price: 2270.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '15', code: '10031', name: 'ClevisTangent', price: 393.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '16', code: '10071', name: 'ClevisDDE', price: 1382.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '17', code: '10032', name: 'ClevisDE', price: 711.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '18', code: '1020070000', name: 'สาย 25 AW', price: 22.10, unit: 'เมตร', department: 'แผนกแรงต่ำ' },
  { id: '19', code: '1020070002', name: 'สาย 50 AW', price: 36.96, unit: 'เมตร', department: 'แผนกแรงต่ำ' },
  { id: '20', code: '1020070004', name: 'สาย 95 AW', price: 71.71, unit: 'เมตร', department: 'แผนกแรงต่ำ' },
  ...
  { id: '23', code: '14001', name: 'ชุดกราวด์+ล่อฟ้า 1P 2W', price: 3363.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '24', code: '14003', name: 'ชุดกราวด์+ล่อฟ้า 3P 4W', price: 4129.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  { id: '25', code: '1040000300', name: 'ล่อฟ้า', price: 383.00, unit: 'ตัว', department: 'แผนกแรงต่ำ' },
  { id: '26', code: '14401', name: 'Fluorescent', price: 5191.00, unit: 'ชุด', department: 'แผนกแรงต่ำ' },
  ...
  { id: '29', code: '10071', name: 'ClevisDDE', price: 1382.00, unit: 'ชุด', department: 'แผนกไฟสาธารณะ' },
  { id: '30', code: '10032', name: 'ClevisDE', price: 711.00, unit: 'ชุด', department: 'แผนกไฟสาธารณะ' },
  { id: '31', code: '1020070000', name: 'สาย 25 AW', price: 22.10, unit: 'เมตร', department: 'แผนกไฟสาธารณะ' },
  ...
  { id: '35', code: '222', name: 'Fluorescent', price: 5191.00, unit: 'ชุด', department: 'แผนกไฟสาธารณะ' },
